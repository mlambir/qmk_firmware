...
#define LOW_SPC LT(LOWER_LAYER, KC_SPC)
#define RAI_SPC LT(RAISE_LAYER, KC_SPC)
...
[BASE_LAYER] = LAYOUT_ortho_4x12(
  ...
  CTL_ESC,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,                        KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  NUM_ENT,
  KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,    KC_LPRN,  KC_RPRN,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
                                KC_HYPR,  KC_LGUI,  SFT_BSP, LOW_SPC,  RAI_SPC,  SFT_ENT,  KC_RGUI,  KC_RALT
),
...
[LOWER_LAYER] = LAYOUT_ortho_4x12(
  ...
  _______,  _______,  _______,  KC_EQL,   KC_LPRN,  KC_RPRN,                     _______,  _______,  _______,  _______,  KC_TILD,  _______,
  _______,  KC_BSLS,  _______,  _______,  KC_LCBR,  KC_RCBR,  KC_LCBR,  KC_RCBR, KC_QUOT,  KC_UNDS,  _______,  _______,  KC_BSLS,  _______,
...
[RAISE_LAYER] = LAYOUT_ortho_4x12(
  ...
  _______,  _______,  _______,  KC_PLUS,  _______,  _______,                      KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_COLN,  _______,
  _______,  KC_PIPE,  _______,  _______,  _______,  _______,  KC_LBRC,  KC_RBRC,  KC_DQUO,  KC_MINS,  _______,  _______,  KC_PIPE,  _______,
